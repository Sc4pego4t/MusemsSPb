 ...
 */
public class ChangeInfoView implements Viewable<String> {
    ...
    public ChangeInfoView(AbstractActivity activity, View rootView, FragmentManager manager) {
        ChangeInfoView.manager =manager;
        context = rootView.getContext();
        this.actionBarBulder = new ActionBarConstructor.Builder(activity)
            .title(R.string.changeInfo)
            .menu(R.menu.empty);
        Log.e("qqq","ad");
        manager.beginTransaction().replace(R.id.container, new ChangeInfoFragment()).commit();
